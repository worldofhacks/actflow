...
export class DeleteTaskHandler extends BaseEventHandler {
  constructor(
    private readonly eventHandlerService: EventHandlerService,
    @Inject(BlockTrackerService) blockTracker: BlockTrackerService,
  ) {
    super('DeleteTask', blockTracker);
  }
  ...
  protected async updateEntityState(
    ...
    await this.eventHandlerService.deleteTask(update.taskId, isHistorical);
  }
}
